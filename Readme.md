# Editor for DataTables with styling for [Bootstrap](https://getbootstrap.com/docs/3.3/)

This is the distribution package for the [Editor extension](https://datatables.net/extensions/editor) for [DataTables](https://datatables.net/) with styling for [Bootstrap](https://getbootstrap.com/docs/3.3/).
...
npm install datatables.net-editor-bs
```
