...
(function(factory){
	if (typeof define === 'function' && define.amd) {
		// AMD
		define(['datatables.net-bs', 'datatables.net-editor'], function (dt) {
			...
			$(document)
				...
				.on('mousedown.dte-bs3', 'div.modal', function (e) {
					...
					allowBackgroundClick =
						$(e.target).hasClass('modal') && shown ? true : false;
				});
